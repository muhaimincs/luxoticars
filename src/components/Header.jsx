  ...
  return (
    <li>
      ...
      >
        {children}
        {isActive && (
          <span className="absolute inset-x-1 -bottom-px h-px bg-gradient-to-r from-red-500/0 via-red-500/40 to-teal-500/0 dark:from-teal-400/0 dark:via-red-400/40 dark:to-red-400/0" />
        )}
      </Link>
    </li>
  )
            ...
            >
              ...
              >
                <div className="relative">
                  ...
                  <Avatar
                    large
                    className="block h-24 origin-left"
