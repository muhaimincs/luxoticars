    ...
    <ParallaxItem scroll={scroll} className="overflow-hidden w-full lg:max-w-prose mx-auto">
      <dl className="shadow-lg grid grid-cols-2 gap-2">
        <div className={`bg-black/50 rounded-xl flex flex-col p-6 bg-cover bg-center ${s['r-gradient']}`}>
          <dt className="order-1 text-xs md:text-lg leading-6 font-medium text-[#93d3f0]">Since</dt>
          <dt className="order-3 text-xs md:text-lg leading-6 font-medium text-[#93d3f0]">Luxoticars in business</dt>
          <dd className="order-2 text-xl font-extrabold text-white">2008</dd>
        </div>
        <div className={`bg-black/50 rounded-xl flex flex-col p-6 bg-cover bg-center ${s['r-gradient']}`}>
          <dt className="order-1 text-xs md:text-lg leading-6 font-medium text-[#93d3f0]">Fulfilling</dt>
          <dt className="order-3 text-xs md:text-lg leading-6 font-medium text-[#93d3f0]">Delivery</dt>
          <dd className="order-2 text-xl font-extrabold text-white">Thousands</dd>
        </div>
      </dl>
    </ParallaxItem>
