...
export default function ParallexAbout () {
  ...
  return (
    <>
    <ParallaxItem scroll={scroll} className="bg-black/50 rounded-xl overflow-hidden w-full lg:max-w-prose mx-auto">
      <dl className={`rounded-lg shadow-lg grid grid-cols-2 bg-cover bg-center ${s['r-gradient']}`}>
    ...
    {/* <ParallaxItem scroll={scroll} className="max-w-prose mx-auto">
